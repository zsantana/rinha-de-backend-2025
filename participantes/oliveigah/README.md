...
Implementação utilizando apenas elixir + haproxy. Sem banco de dados externos, sem fila externa. Suportando até 4000 VUs com p99 de 2ms.

A fila e o armazenamento foram implementados diretamente na app utilizando ETS (erlang term storage).

codigo fonte: https://github.com/oliveigah/rinha-de-backend-2025
